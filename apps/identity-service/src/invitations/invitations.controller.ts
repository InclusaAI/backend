...
export class InvitationsController {
  ...
  @ApiResponse({ status: 403, description: 'Forbidden. Inviter is not an admin.' })
  @ApiResponse({ status: 409, description: 'User is already a member or an invitation is pending.' })
  create(
