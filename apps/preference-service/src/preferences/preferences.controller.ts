...
export class PreferencesController {
  ...
  @ApiResponse({ status: 200, description: 'The user\'s current accessibility preferences.' })
  ...
  @ApiResponse({ status: 200, description: 'The updated accessibility preferences.' })
  @ApiResponse({ status: 401, description: 'Unauthorized.' })
  update(@Req() req, @Body() updatePreferencesDto: UpdatePreferencesDto): Promise<AccessibilityPreference> {
